          ...
          parsedResults.link.forEach(function(link){
            ...
            if(get(link, 'relation') === "next"){
              ...
              if(apiKey){
                ...
                self.recursiveEncounterQuery(get(link, 'url'))
              }
            }
          })
        }
          ...
          parsedResults.link.forEach(function(link){
            ...
            if(get(link, 'relation') === "next"){
              ...
              if(apiKey){
                ...
                self.recursiveProceduresQuery(get(link, 'url'))
              }
            }
          })
        }
          ...
          parsedResults.link.forEach(function(link){
            ...
            if(get(link, 'relation') === "next"){
              ...
              if(apiKey){
                ...
                self.recursiveObservationsQuery(get(link, 'url'))
              }
            }
          })
        }
          ...
          parsedResults.link.forEach(function(link){
            ...
            if(get(link, 'relation') === "next"){
              ...
              if(apiKey){
                ...
                self.recursiveDiagnosticReportsQuery(get(link, 'url'))
              }
            }
          })
        }
          ...
          parsedResults.link.forEach(function(link){
            ...
            if(get(link, 'relation') === "next"){
              ...
              if(apiKey){
                ...
                self.recursiveDocumentReferenceQuery(get(link, 'url'))
              }
            }
          })
        }
